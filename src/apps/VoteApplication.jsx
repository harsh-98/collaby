  ...
  render() {
    return (
      <div style={{ marginBottom: '50px' }}>
        ...
        <ul>
          {Object.keys(this.state.vote.candidates).map((s,i) => (<li key={i}>{s}: {this.state.vote.candidates[s]} <input data-index={s} type="button" value="Vote" onClick={this.handleAddVote} /></li>))}
        </ul>
      </div>);
  }
}
